...
const GLOSSARIO = {
  ...
  // o que é cada sugestão de formato e de ângulo (o (i) ao lado de cada uma)
  sugestoes: {
    formato: {
      "Carrossel storytelling (pedido → produção → entrega)": "Carrossel que conta o case como história, na ordem: o pedido do cliente, a produção na fábrica e a entrega. Cada slide é um capítulo e o último fecha com o resultado.",
      "Mini documentário de 60 s": "Vídeo curto com cara de documentário: imagens reais do cliente e da produção, com narração ou legenda contando o que aconteceu, em até 1 minuto.",
      "Foto real + texto": "Uma foto de verdade do boné em uso pelo cliente, com o texto do case por cima ou na legenda. Sem montagem: a foto real é a prova.",
      "Antes e depois (logo no papel → boné pronto)": "Mostra o logo como chegou (arquivo, rascunho, papel) e o boné pronto ao lado ou no slide seguinte. A transformação é o gancho.",
      "Repost de story do cliente": "Republica o story em que o cliente mostrou ou marcou a SeuBoné, com um contexto curto. Só com autorização do cliente.",
      "Vídeo contando o case com gancho forte": "Alguém da SeuBoné conta o case olhando pra câmera, abrindo com a frase mais forte: o número, a marca ou o problema.",
      "Alguém contando o case": "O próprio cliente (ou alguém do time dele) conta em vídeo por que pediu e como foi. Vale mais que a marca falando de si.",
      "Carrossel checklist": "Carrossel em forma de lista de conferência: o que checar antes de pedir boné (arte, modelo, prazo, quantidade). Feito pra salvar e usar depois.",
      "Péssimo x bom x excelente": "Compara três versões da mesma coisa (ex.: logo mal aplicado, aplicado ok e aplicado do melhor jeito) e ensina pela diferença.",
      "Erro comum": "Mostra um erro que muita empresa comete ao pedir boné e como evitar. Começa pelo erro, que é o que prende.",
      "Use isso pra isso": "Liga cada opção ao uso certo: este modelo pra evento ao ar livre, este pra uniforme, este pra brinde premium. Direto e bom de salvar.",
      "Mitos e verdades": "Lista crenças comuns sobre boné personalizado e diz o que é mito e o que é verdade, com uma linha de explicação em cada.",
      "Tier list": "Ranking visual em níveis (S, A, B, C) de modelos, aplicações ou usos. Formato de internet que puxa comentário e discordância.",
      "Quadro branco": "Alguém explica desenhando no quadro branco (ou no papel) enquanto fala. Passa cara de aula e de especialista.",
      "FAQ": "As perguntas que os clientes mais fazem, respondidas uma por slide ou uma por corte de vídeo.",
      "Como fazer": "Passo a passo de algo que o cliente precisa fazer, como mandar a arte do jeito certo ou escolher o tamanho.",
      "Como funciona": "Explica um processo por dentro (como o bordado é feito, como sai o orçamento) pra quem nunca pediu.",
      "Número gigante": "Um único número grande ocupando a tela (ex.: bonés produzidos, clientes atendidos) e uma linha curta embaixo. O número é o gancho. Confirmar o número antes de postar.",
      "Placar de 3 números": "Três números lado a lado, como um placar (ex.: clientes, bonés, anos). Mostra a escala de uma vez só.",
      "Card de avaliação com estrelas": "Arte com uma avaliação real de cliente, as estrelas e o nome ou a empresa. Parece o print do Google, mas limpo e na identidade da marca.",
      "Print de depoimento": "Print real da conversa, e-mail ou avaliação em que o cliente elogia. Borrar dado pessoal e ter autorização.",
      "Pilha de depoimentos": "Vários depoimentos curtos empilhados na mesma arte ou no carrossel. O volume é a prova.",
      "Vídeo depoimento": "O cliente fala em vídeo sobre a experiência. Pode ser gravado por ele mesmo, no celular.",
      "Repost de story": "Republica o story em que alguém mostrou ou marcou a SeuBoné. Só com autorização.",
      "Feedback com foto": "A frase do cliente junto com a foto dele (ou da equipe) usando o boné.",
      "Feedback em vídeo": "Vídeo curto do cliente reagindo ao receber ou usando o boné, com o comentário dele.",
      "Depoimento em vídeo": "O cliente conta, num vídeo mais completo, por que escolheu a SeuBoné e como foi o resultado.",
      "NPS": "Mostra a nota de satisfação dos clientes (NPS, que vai de -100 a 100) como prova. Só com o número real e atualizado.",
      "Carrossel de bonés + feedback de quem recebeu": "Cada slide traz um boné produzido e a frase de quem recebeu. Junta produto e prova no mesmo post.",
      "POV com o boné na mão": "Vídeo em primeira pessoa, do ponto de vista de quem segura o boné: de perto, virando, mostrando o detalhe.",
      "Detalhe com zoom": "Close no acabamento (bordado, costura, etiqueta, fecho) pra mostrar a qualidade que a foto de longe não mostra.",
      "Comparativo modelo A x B": "Dois modelos lado a lado, com as diferenças e pra quem cada um serve. Ajuda quem está em dúvida.",
      "Callout com setas": "Foto do boné com setas apontando cada detalhe e uma legenda curta em cada seta.",
      "Grid de cores": "Grade com o mesmo modelo em todas as cores disponíveis. Bom de salvar e mostrar pro time.",
      "Foto com bullets": "Foto do produto com 3 ou 4 tópicos curtos ao lado: material, aplicação, uso ideal.",
      "Giro de notícia": "Pega uma notícia do momento que envolve boné, marca ou evento e comenta do ponto de vista da SeuBoné.",
      "Trend / POV": "Usa um formato ou áudio em alta no Instagram, adaptado pro mundo do boné e da fábrica.",
      "Meme": "Meme com uma situação que o público reconhece (ex.: o brinde que ninguém usa). Leve, compartilhável, sem forçar venda.",
      "Starter pack": "Montagem com os itens típicos de um perfil (ex.: \"starter pack de quem organiza evento\"), com o boné no meio.",
      "React": "Reagir em vídeo a um post, notícia ou vídeo de outra marca ou do setor, comentando com a visão da SeuBoné.",
      "Teaser": "Mostra só um pedaço do que vem (lançamento, novidade, parceria) pra gerar curiosidade antes de revelar.",
      "Anúncio de novidade": "Post direto anunciando algo novo: modelo, cor, aplicação ou serviço.",
      "Timeline de prazo": "Linha do tempo mostrando até quando pedir pra chegar a tempo de uma data: pedido até tal dia, produção, entrega.",
      "Notificação / lembrete": "Arte que imita uma notificação do celular ou um lembrete de agenda avisando do prazo.",
      "Checklist / FAQ": "Lista do que o cliente precisa ter pronto pra pedir agora, ou as dúvidas mais comuns sobre prazo e quantidade.",
      "Callout": "Arte com uma chamada curta e forte em destaque (ex.: \"Última semana pra pedir pro fim de ano\").",
      "Frase-manifesto": "Uma frase de posição da marca em destaque, sem produto em primeiro plano (ex.: \"Brinde bom é o que a pessoa usa depois\").",
      "Grid / colagem": "Vários bonés ou pedidos na mesma arte, em grade ou colagem, mostrando volume e variedade.",
      "Bastidores do dia": "O que está acontecendo hoje na fábrica, gravado no celular, sem produção elaborada.",
      "Horizontal cinemático": "Vídeo com cara de filme (planos bonitos, luz, trilha) mostrando a fábrica. Mais institucional, eleva a percepção da marca.",
      "Passo a passo (do logo ao boné)": "Mostra cada etapa em ordem, do arquivo do logo até o boné embalado.",
      "Detalhe da máquina bordando": "Close da máquina de bordado trabalhando. Prende o olho e mostra a produção acontecendo.",
      "Vlog": "Alguém do time mostra a fábrica e o dia a dia falando com a câmera, como um diário.",
      "Foto de celular com flash": "Foto crua, com flash, com cara de \"feito agora\". Passa verdade e bastidor sem produção.",
      "Simulação com o logo (arte → boné pronto)": "Mostra como funciona simular o boné com o logo do cliente: a arte entra e o boné pronto aparece na tela.",
      "Fala direta do vendedor (oferta, suporte, CTA)": "O vendedor fala pra câmera: qual é a oferta, como ele ajuda a pessoa e o que fazer agora.",
      "Chat WhatsApp (\"como é pedir\")": "Arte ou vídeo imitando a conversa no WhatsApp com a SeuBoné, mostrando como é simples pedir.",
      "Anti-anúncio": "Post que brinca de \"isso não é um anúncio\" ou fala com uma honestidade crua, quebrando o tom de propaganda.",
      "Ugly post": "Arte de propósito simples e crua (texto em fundo liso, print, rabisco). Chama atenção por fugir do post bonito.",
      "Fala direta do fundador": "O fundador fala pra câmera sobre a empresa, o mercado ou uma opinião. Rosto e voz de quem manda passam confiança.",
      "Carta do fundador": "Texto em primeira pessoa assinado pelo fundador, em carrossel ou imagem, com a visão da empresa.",
      "Selo de imprensa": "Mostra onde a SeuBoné saiu na imprensa ou recebeu prêmio, com o logo do veículo e a manchete.",
      "Retrospectiva (datas e conquistas)": "Linha do tempo com os marcos da empresa: fundação, clientes grandes, crescimento.",
      "Bastidor de marca grande": "Mostra a produção de um pedido de marca conhecida, usando a marca como gancho. Só com autorização.",
      "Calendário de datas com prazo de pedido": "Calendário com as próximas datas comerciais e até quando pedir pra cada uma chegar a tempo.",
      "Teaser da data": "Avisa que uma data está chegando e dá uma ideia de boné pra ela, antes da correria.",
      "Grid de modelos temáticos": "Grade de bonés pensados pra uma data: cores, frases, aplicação temática.",
      "Case da mesma data no ano passado": "Mostra o que um cliente fez na mesma data no ano passado e o resultado, como inspiração."
    },
    angulo: {
      "O problema que o boné resolveu": "Conta o case pela dor que o cliente tinha antes (ex.: brinde que ninguém usava) e como o boné resolveu.",
      "Qual foi o uso": "Conta o case pelo uso: em qual evento, ação ou equipe o boné foi usado e como apareceu.",
      "Que efeito resultou": "Conta o case pelo resultado: fotos, alcance, equipe uniformizada, recompra. A peça termina no efeito.",
      "Qual modelo pra qual uso (trucker, aba curva, aba reta...)": "Ensina a escolher o modelo certo pra cada uso: evento, uniforme, brinde, varejo.",
      "Bordado x silk x patch x sublimação": "Compara as formas de aplicar o logo: onde cada uma fica melhor, quanto dura e o que muda no resultado.",
      "Quando pedir pra chegar a tempo do evento": "Ensina a contar o prazo de trás pra frente a partir da data do evento.",
      "Erros de arte (logo pequeno demais, cor que não borda)": "Mostra os erros de arquivo e de arte que atrasam ou estragam o pedido, e como evitar cada um.",
      "Quantos bonés pedir": "Ajuda a calcular a quantidade certa pro evento ou pra equipe, sem sobrar nem faltar.",
      "Como fazer o brinde ser usado depois do evento": "Ensina o que faz um boné virar peça do dia a dia (modelo, cor, logo discreto) em vez de ir pra gaveta.",
      "Clientes atendidos e bonés produzidos (confirmar os números antes de postar)": "Prova pela escala: quantos clientes e quantos bonés. Só com o número confirmado.",
      "Avaliação no Google": "Prova pela nota e pelos comentários públicos no Google.",
      "Cliente que recompra": "Prova pela fidelidade: quem pediu uma vez, voltou, e por quê.",
      "Marcas conhecidas que usam": "Prova pela reputação de quem já comprou. Só citar marca com autorização.",
      "Bonés que saíram essa semana": "Prova pelo movimento: o que foi produzido e entregue nos últimos dias.",
      "Um modelo por post e pra quem ele serve": "Foca num modelo só e diz pra que tipo de empresa ou uso ele é o ideal.",
      "Uma aplicação de perto (bordado 3D, patch de couro, silk)": "Foca numa forma de aplicação e mostra de perto como ela fica no boné.",
      "O mesmo logo em 3 modelos": "Mostra o mesmo logo aplicado em 3 modelos diferentes, pra ajudar quem ainda não escolheu.",
      "Combinações de cor": "Mostra combinações de cor do boné e da linha ou aplicação que funcionam bem juntas.",
      "Acabamento interno": "Mostra o lado de dentro (forro, fita, etiqueta), o detalhe que só quem entende repara.",
      "Marca conhecida usando boné em ação": "Mostra uma marca conhecida usando boné num evento ou campanha, de preferência um boné feito pela SeuBoné.",
      "Lançamento de modelo ou cor": "Novidade do catálogo: modelo, cor ou aplicação que acabou de chegar.",
      "Bastidor de pedido grande (com autorização)": "Mostra a produção de um pedido grande em andamento. Só com autorização do cliente.",
      "Trend de áudio gravada na fábrica": "Usa um áudio em alta, gravado com as pessoas e as máquinas da fábrica.",
      "Coisas que só quem compra brinde corporativo passa": "Humor com as situações que quem cuida de brinde vive: prazo, aprovação, fornecedor que some.",
      "Contagem regressiva com o prazo real (\"pra chegar na confraternização de dezembro, o pedido fecha até [data]\")": "Usa o prazo real de produção pra criar uma urgência honesta: até quando pedir pra chegar a tempo.",
      "Fim de ano, Black Friday, feiras do setor, SIPAT, kit de boas-vindas": "Liga o boné a uma data ou ocasião em que empresa costuma comprar brinde.",
      "O prazo de 7 ou 14 dias úteis como saída pra quem atrasou": "Fala com quem deixou pra última hora: ainda dá tempo com o prazo curto de produção.",
      "Uma etapa por vídeo (digitalização do logo, bordado, corte, costura, controle de qualidade, embalagem)": "Cada vídeo mostra uma etapa só da produção, de perto e sem pressa. Rende uma série.",
      "O rosto de quem faz": "Apresenta as pessoas da fábrica: quem borda, quem corta, quem confere.",
      "Escala (\"quantos bonés saem por dia\")": "Mostra o tamanho da operação pelo volume de um dia. Confirmar o número.",
      "O erro que o controle de qualidade pega": "Mostra um defeito barrado antes de sair da fábrica, o que prova o cuidado.",
      "Fábrica exclusiva": "Mostra a fábrica da SeuBoné como diferencial e o que ela garante pro cliente: prazo, qualidade e controle.",
      "Simule com o seu logo e veja antes de pagar": "Oferece a simulação com o logo do cliente como primeiro passo, antes de qualquer pagamento.",
      "Como é pedir, em 3 passos": "Mostra que pedir é simples, em 3 passos claros.",
      "Quantidade mínima e prazo": "Responde de cara as duas dúvidas que mais travam o pedido: quantos no mínimo e em quanto tempo.",
      "Condição do mês (confirmar com o comercial antes de citar)": "Divulga a condição comercial do mês. Só com o ok do comercial.",
      "Kit pronto pra evento ou equipe": "Oferece um combinado pronto (modelo, quantidade, aplicação) pra pessoa decidir rápido.",
      "Escala da operação (confirmar os números)": "Mostra o tamanho da SeuBoné em números pra gerar confiança. Confirmar os números.",
      "Marcas grandes atendidas": "Mostra marcas conhecidas que confiaram na SeuBoné. Só com autorização.",
      "Tempo de mercado": "Mostra há quanto tempo a SeuBoné faz isso e o que aprendeu no caminho.",
      "Imprensa e reconhecimento": "Mostra onde a SeuBoné apareceu na mídia e os prêmios que recebeu.",
      "O fundador falando de marca e brinde que funciona": "O fundador dá a visão dele sobre o que faz um brinde funcionar e fortalecer a marca.",
      "Quando pedir pra cada data chegar a tempo": "Organiza as próximas datas e o prazo de pedido de cada uma.",
      "Ideia de boné pra data (cor, aplicação, frase)": "Dá uma ideia pronta de boné pra data, pra pessoa se imaginar pedindo.",
      "Como uma empresa usou boné na mesma data": "Mostra um cliente que usou boné nessa data e como foi.",
      "Datas do setor do cliente (feira, convenção, lançamento)": "Fala das datas do setor do cliente, e não só das datas do calendário geral."
    },
  },
  valores: {
    objetivo: {
