...
module.exports = function criarUso({ db, fs, dataFile, limiteGB, comGitHub }) {
  ...
  let cache = null;                     // resumo guardado por 60 s (o painel pergunta a cada 20 s)
  ...
  function gravou(bytes) {
    ...
    cache = null;                       // mudou alguma coisa: o próximo resumo recalcula (peso dos documentos incluso)
    if (!comGitHub) return;
